...
import org.apache.iceberg.RepairLegacyFileSystemTableProcedure;
        ...
        implements Module
{
    ...
    public void configure(Binder binder)
    {
        ...
        procedures.addBinding().toProvider(RepairLegacyFileSystemTableProcedure.class).in(Scopes.SINGLETON);
